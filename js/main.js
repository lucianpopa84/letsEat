...
document.querySelector("#topMenuAbout").addEventListener("click", renderAboutHtml);

document.querySelector("#topMenuContact").addEventListener("click", renderContactHtml);
