      ...
      .then(restaurantsData => {
         ...
         if (restaurantsData.length >= 1) {
            ...
            for (let restaurantData of restaurantsData) {
               htmlContent += `
                    <div class="restaurantCard" id="restId${
                       restaurantData.id
                    }" onclick="displayFood(this,${restaurantData.id})"> 
                        <div class="row">
                            <div class="col-3">
               ...
               if (
                  ...
                  htmlContent += `<p> <i class="fas fa-truck"></i> <span class="deliveryTime"> ${
               ...
               htmlContent += `</div>
                            ...
                            <div class="col-4">
                                <div class="card-pricing">
                                    <p> From: ${
                                       restaurantData.pricingFrom
                                    } RON </p>
                                    <p> To: ${restaurantData.pricingTo} RON </p>
                                    <p> Min: ${
                                       restaurantData.pricingMin
                                    } RON </p>
                                </div>
                            </div>
                        </div>
...
document.querySelector("#topMenuHome").addEventListener("click", () => {
   window.location = "index.html";
});

document
   .querySelector("#topMenuAbout")
   .addEventListener("click", renderAboutHtml);

document
   .querySelector("#topMenuContact")
   .addEventListener("click", renderContactHtml);
...
function renderAboutHtml() {
   ...
   let htmlContent = `
    <h2 style="text-align:center;">About <span style="color:darkblue;">Let's Eat</span> </h2> 
    <hr>
    <p>This website is designed to help you order food quick and easy.</p>
    <p>If you have a favourite restaurant which is not listed, please use the <i>Add a restaurant</i> form.</p>
    <br>
    <p>© 2019 Lucian Popa</p>`;
   about.innerHTML = htmlContent;
   topDropdownMenu.style.display = "none";
}
   ...
   let htmlContent = `
    ...
    <div class="contactForm">
        <form>
            ...
            <input type="text" id="name" name="firstname" autocomplete="name" placeholder="Your name..">
        ...
        <p>
            ...
            <a href="mailto:contact@letseat.com?Subject=Hello%20Letseat" target="_top">contact@letseat.com</a>
        </p>
    </div>
</div>`;
...
function displayFood(restaurant, id) {
   ...
   fetch(url)
      ...
      .then(foodData => {
         ...
         let restaurantCardId = restaurantList.querySelector(
            `#${restaurant.id}`
         );
         let restaurantTime = restaurantCardId.querySelector(".deliveryTime")
            .innerHTML;
         if (restaurantTime == " closed ") {
            ...
            if (restaurantList.hasChildNodes()) {
               let restaurantCards = restaurantList.querySelectorAll(
                  ".restaurantCard"
               );
                            ...
                            <div class="card-pricing">
                                <form class="priceForm ${
                                   foodItem.restaurantId
                                    ...
                                    <button class="priceButton" data-price="${
                                       foodItem.price
            ...
            const priceFormButtons = document.querySelectorAll(
               ".priceForm > button"
            );
            ...
            const priceFormQuantityInputs = document.querySelectorAll(
               ".priceForm > input[type=number]"
            );
            for (let [
               index,
               priceFormQuantity
            ] of priceFormQuantityInputs.entries()) {
...
function renderCartHtml() {
   ...
   for (let i in cartItems) {
      htmlContent += `
            <div class="foodCard" data-name="${
               cartItems[i].foodName
            }" data-price="${cartItems[i].itemPrice}">
            <div class="row">
                <div class="col-3">
                    <div class="card-image">
                        <img src="${cartItems[i].imageSrc}" alt="${
         cartItems[i].imageAlt
      }">
                    </div>
                </div>
                <div class="col-3">
                ...
                <div class="col-4">
                    <div class="card-pricing">
                        <form class="priceForm">
                            <input type="number" name="quantity" min="1" max="10" value="${
                ...
                <div class="col-2">
                    <p class="price">${cartItems[i].itemPrice *
                       cartItems[i].quantity} RON</p>
                </div>
            </div>
        </div>
        `;
   ...
   const detectedDeliveryPlaceText = document.querySelector(
      "#detectedDeliveryPlace"
   );
...
function removeItem(event) {
   ...
   let cartItemIndex = cartItems.findIndex(
      cartItem => cartItem.foodName == foodItemName
   );
