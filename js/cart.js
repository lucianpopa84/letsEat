              ...
              <div className="row">
                <div className="col-3">
                  <div className="card-image">
                    <img src={cartItem.imageSrc} alt={cartItem.imageAlt} />
                  </div>
                </div>
                <div className="col-3">
...
function Topnav() {
  ...
  if (cartItemsNumber < 1 || cartItemsNumber == null) {
    setCartItemsNumber("");
  }
  ...
  return (
    <div>
      ...
      <a href="#cart" id="cartButton" onClick={() => renderCartHtml()}>
        <i className="fas fa-shopping-cart" />
      </a>

      <span className="cartItems">{cartItemsNumber}</span>
    </div>
  );
}
